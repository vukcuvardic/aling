...
<div class="container">
    <div class="content">
        ...
        <div class="news-page">
            ...
            <div class="news-other panel">
                <h2>Ostale vesti</h2>
                <ul>
                    <li><a href="#"><h3>Vest 1</h3></a></li>
                    <li><a href="#"><h3>Vest 2</h3></a></li>
                    ...
                    <li><a href="#"><h3>Vest 10</h3></a></li>
                </ul>
                <button type="button" class="btn btn-default">Učitaj starije vesti</button>
            </div>
        </div>
    </div>
</div>
